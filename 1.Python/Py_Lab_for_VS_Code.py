...
# # 코드 작성
# total = int (int(p) + int(p) * float(t) / 100)
# temp = total % 1000
# total = total - temp
# print( total )
...
# # 코드 작성
# index, name = input().split()

# l.insert(int(index)-1, name)
# print(l)
...
# index, name = input().split()
# list_t = list(t)
# list_t.insert(int(index)-1, name)
...
# [3-17] 과일 코드 출력
############################################################
# fruit = {'apple': 10, 'mango':12, 'orange':17}
